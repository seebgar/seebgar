      ...
      <div className="ContextContainer">
        ...
        <div className="uk-flex uk-flex-center uk-flex-middle Content">
          ...
          >
            ...
            <img src={MAC} id="MAC" alt="Mockup G-L" width="600px" className="FloatingImg" data-uk-parallax="y: -200; easing: 0.5"/>
          </div>
        </div>
          ...
          <div className="uk-child-width-1-1 uk-child-width-1-2@m" data-uk-grid>
            ...
            <div>
              <p className="ProjectText">
                G&amp;L is a consultancy business whose main goal is to train
                and help their clients in legal defense. My job was brand design
                and to develop their main web site which helped to gain
                recognition over 10+ cities nationwide (Colombia) and
                established a clear communication between G&amp;L and their
                1000+ new clients and students.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="uk-flex uk-flex-center uk-flex-middle Content">
          ...
          >
            ...
            <img src={KEYBOARD} alt="Keyboard and Mouse" width="600px" className="FloatingImg PERIS" data-uk-parallax="y: -200; easing: 0.5"/>
            <img src={MOUSE} alt="Keyboard and Mouse" width="600px" className="FloatingImg PERIS2" data-uk-parallax="y: 100; easing: 0.5"/>
          </div>
        </div>
          ...
          <div className="uk-child-width-1-1 uk-child-width-1-2@m" data-uk-grid>
            ...
            <div>
              <p className="ProjectText">
                ...
                iterating over avast amount of data using the most efficient
                algorithms.
              </p>
            </div>
            <div>&nbsp;</div>
            <div>
              <p className="ProjectText">
                ...
                fundamental concepts in algorithms and object-oriented
                programing.
              </p>
            </div>
          </div>
